...
?>
	...
	function shortcode_vc_mailchimp( $atts, $content= null ) {
		...
		<input type="hidden" name="welcome_email" value="'.$settings['welcome_email'].'" >
		<input type="hidden" name="update_existing" value="'.$settings['update_existing'].'" >
	...
	function get_input_styles( $attr ) {
		...
		$input_styles.= empty( $attr['font_size'] )?'':'font-size:'. $attr['font_size'].';';
	...
	function ajax_vc_mailchimp_form_submit() {
		...
		$double_optin = ($params['double_optin'] == '1') ? true: false;
		$welcome_email = ($params['welcome_email'] == '1') ? true: false;
		$update_existing = ($params['update_existing'] == '1') ? true: false;
