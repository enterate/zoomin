...
class VC_Mailchimp_Map {
	...
	function __construct() {
		if ( function_exists( 'vc_add_shortcode_param' ) ) {
			vc_add_shortcode_param( 'vc_mailchimp_options_field', array( $this, 'options_field' ), VC_MAILCHIMP_URL."/js/vc-mailchimp-admin.js" );
			vc_add_shortcode_param( 'vc_mailchimp_border_field', array( $this, 'border_field' ), VC_MAILCHIMP_URL."/js/vc-mailchimp-admin.js"  );
		}
	}
	...
	public function map_fields() {
		...
		vc_map( array(
				...
				"params" => array(
					...
					array(
						"type" => "dropdown",
						"heading" => __( "Mailchimp List", "vc_mailchimp" ),
						"param_name" => "list",
						"value" => array_flip( $this->vc_mailchimp_get_mailchimp_lists() ),
						"description" => __( "Select List to which you want to add users ", "vc_mailchimp" ),
						"admin_label" => true
					),
					array(
						"type" => "checkbox",
						...
						array(
						"type" => "checkbox",
						"heading" => __( "Receive Welcome Email ?", "vc_mailchimp" ),
						"param_name" => "welcome_email",
						"edit_field_class" => "vc_col-sm-6 vc_column",
						'value' => array( __( 'Enable', 'vc_mailchimp' ) => '1' ),
						"description" => __( "Enable receiving welcome email from mailchimp after subscriptions.", "vc_mailchimp" ),

					),
							array(
						"type" => "checkbox",
						"heading" => __( "Update existing contact ?", "vc_mailchimp" ),
						"param_name" => "update_existing",
						'value' => array( __( 'Enable', 'vc_mailchimp' ) => '1' ),
						"description" => __( "Enable it to update existing contacts in mailchimp on form submit", "vc_mailchimp" ),
					...
					array(
						"type" => "textfield",
						"heading" => __( "Form Width", "vc_mailchimp" ),
						"param_name" => "width",
						"value" => '',
					...
					array(
						"type" => "textfield",
						"heading" => __( "Form Height", "vc_mailchimp" ),
						"param_name" => "height",
						"value" => '',
					...
					array(
						"type" => "textfield",
						"heading" => __( "Form Margin", "vc_mailchimp" ),
						"param_name" => "margin",
						"value" => '',
					...
					array(
						"type" => "textfield",
						"heading" => __( "Form Padding", "vc_mailchimp" ),
						"param_name" => "padding",
						"value" => '',
					...
					array(
						"type" => "colorpicker",
						"heading" => __( "Form Background Color", "vc_mailchimp" ),
					...
					array(
						...
						"heading" => __( "Form Border", "vc_mailchimp" ),
						"param_name" => "border",
						"value" => '',
					...
					array(
						"type" => "textfield",
						"heading" => __( "Form Border Radius", "vc_mailchimp" ),
					...
					array(
						"type" => "dropdown",
						"heading" => __( "Form Fields Align", "vc_mailchimp" ),
						"param_name" => "align",
					...
					array(
						"type" => "textfield",
						"heading" => __( "Invalid Email Error Message", "vc_mailchimp" ),
						"param_name" => "email_validation_msg",
						"value" => 'Please enter a valid email',
						"description" => __( "Error to show if email field is empty or invalid", "vc_mailchimp" ),
						"admin_label" => false,
		...
		vc_map( array(
				...
				"params" => array(
					...
					array(
						"type" => "textfield",
						"heading" => __( "Input Box Font Size ", "js_composer" ),
	...
	public function vc_mailchimp_get_mailchimp_lists( ) {
		...
		$lists = get_transient( 'vc_mailchimp_lists' );
		if ( !empty( $lists ) ) {
			return  $lists;
		}
		...
		$mailchimp_lists =array( 'Select List' );
		...
		if ( empty( $settings['api_key'] ) ) {
			$error['0']='The API key you have entered appears to be invalid';
			return $error;
		}else {
		...
		try {
			...
			if ( $list_data ) {
				...
				set_transient( 'vc_mailchimp_lists', $mailchimp_lists, 60*60*60 );
			}


		} catch( Exception $e ) {

			$mailchimp_lists =array( 'The API key you have entered appears to be invalid' );
