...
if ( ! function_exists( ( 'inbound_enqueue_scripts' ) ) ) {
	function inbound_enqueue_scripts() {
		...
		if ( ! inbound_option( 'advanced_no_parallax', false ) ) {
		...
		if ( ! inbound_option( 'advanced_no_parallax', false ) ) {
			$dependencies[] = 'inbound-skrollr';
		}

		wp_enqueue_script( 'inbound-site', get_template_directory_uri() . '/js/inbound.js', $dependencies, $theme_version, true );
	}
}
