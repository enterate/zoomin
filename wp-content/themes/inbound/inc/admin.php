...
if ( ! function_exists( 'inbound_init_admin' ) ) {
	function inbound_init_admin() {
		...
		$options_panel->addCheckbox( 'advanced_no_parallax', array(
			'name'    => esc_html__( 'Disable parallax effect', 'inbound' ),
			'caption' => esc_html__( 'Disable the parallax effect library.', 'inbound' ),
			'desc'    => esc_html__( 'If this option is checked, the parallax effect library will not be loaded and initialized.', 'inbound' ),
			'std'     => false
		) );
