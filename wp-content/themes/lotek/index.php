	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<?php if(!empty($theme_options['blog_home_text'] )) :?>
				<h4><?php echo esc_html($theme_options['blog_home_text'] ) ;?></h4>
				<?php endif;?>
				<?php if(!empty($theme_options['blog_intro'] )) :?>
				<p><?php echo esc_html($theme_options['blog_intro'] ) ;?></p>	
				<?php endif;?>		
			</div>
		</div>
	</div>
